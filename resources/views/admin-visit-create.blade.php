...
<head>
    ...
    <title>Create Physiotherapy Visit - Khayra Physio</title>
    <style>
    ...
    <main class="main">
        <div class="container">
            ...
            <section class="section-card">
                <h1 class="title">Create Physiotherapy Visit</h1>
                <p class="subtitle">
                    Jadwalkan visit fisioterapi baru dengan menghubungkan patient, booking, physiotherapy staff, dan status sesi.
                </p>
