        ...
        <div class="shell">
            <section class="form-panel">
                ...
                <div class="form-wrap">
                    ...
                    <form method="POST" action="/therapist/login">
                        ...
                        <div class="field">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" placeholder="Enter your therapist email">
                        </div>
                ...
                <div class="footer-row">
                    <span>Internal therapist access only</span>
                    <a href="/">← Back to Home</a>
                </div>
            </section>

            <section class="image-panel">
                <img src="/images/therapist-login-bg.png" alt="Therapist Workspace">
